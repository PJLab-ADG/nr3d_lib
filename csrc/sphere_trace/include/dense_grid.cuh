...
class DenseGrid {
  public:
    ...
    HOST_DEVICE glm::vec3 advance_to_next_voxel(glm::vec3 pos, glm::ivec3 voxel, glm::vec3 dir,
        ...
        glm::vec3 new_pos;
        new_pos[axis] = next_grid[axis]; // + 1e-4f * (dir_sign[axis] * 2 - 1);
    ...
    HOST_DEVICE int32_t ray_march(glm::vec3 origin, glm::vec3 dir, float near, float far,
                                  glm::vec2 *__restrict__ o_segs, int32_t debug_maxsegs = 0,
                                  int *o_debug_flag = nullptr, glm::vec3 *o_debug_poses = nullptr,
