...
from nr3d_lib.graphics.pack_ops import packed_cumsum, packed_cumprod, packed_alpha_to_vw, packed_volume_render_compression
...
# def ray_volume_render(vw: torch.Tensor, depths: torch.Tensor, rgb: torch.Tensor=None, nablas: torch.Tensor=None):
#     pass

# def packed_volume_render(vw: torch.Tensor, pack_infos: torch.LongTensor, depths: torch.Tensor, rgb: torch.Tensor=None, nablas: torch.Tensor=None):
#     pass
