...
blidx = torch.randint(forest.n_trees, size=x.shape[:-1], device=device, dtype=torch.long)

y, dydx = _backend.lod_fwd(metas, x, params, blidx, None, None, None, True)
...
dLdx, dLdparam = _backend.lod_bwd(metas, grad, x, params, dydx, blidx, None, None, None, True, True)
dLddLdy, dLdparam_i, dLdx_i = _backend.lod_bwd_bwd_input(metas, grad_input, grad, x, params, dydx, blidx, None, None, None, True, True, True)
...
print(Timer(
    stmt='_backend.lod_fwd(metas, x, params, blidx, None, None, max_level, False)',
    globals={'_backend':_backend, 'metas': metas, 'x':x, 'params':params, 'blidx':blidx, 'max_level': max_level}
).blocked_autorange())

#  ms @ float,half + 360k rand pts
# 39.18 ms @ float,half + 3.6M real pts
print(Timer(
    stmt='_backend.lod_fwd(metas, x, params, blidx, None, None, max_level, True)',
    globals={'_backend':_backend, 'metas': metas, 'x':x, 'params':params, 'blidx':blidx, 'max_level': max_level}
).blocked_autorange())
...
print(Timer(
    stmt='_backend.lod_bwd(metas, grad, x, params, dydx, blidx, None, None, max_level, True, False)',
    globals={'_backend':_backend, 'metas': metas, 'x':x, 'params':params, 'dydx':dydx, 'grad': grad, 'blidx':blidx, 'max_level': max_level}
).blocked_autorange())

#  ms @ float,half + 360k rand pts
# 79.05 ms @ float,half + 3.6M real pts
print(Timer(
    stmt='_backend.lod_bwd(metas, grad, x, params, dydx, blidx, None, None, max_level, False, True)',
    globals={'_backend':_backend, 'metas': metas, 'x':x, 'params':params, 'dydx':dydx, 'grad': grad, 'blidx':blidx, 'max_level': max_level}
).blocked_autorange())
...
print(Timer(
    stmt='_backend.lod_bwd(metas, grad, x, params, dydx, blidx, None, None, max_level, True, True)',
    globals={'_backend':_backend, 'metas': metas, 'x':x, 'params':params, 'dydx':dydx, 'grad': grad, 'blidx':blidx, 'max_level': max_level}
).blocked_autorange())
...
print(Timer(
    stmt='_backend.lod_bwd_bwd_input(metas, grad_input, grad, x, params, dydx, blidx, None, None, max_level, False, True, False)', 
    globals={'_backend':_backend, 'metas': metas, 'x':x, 'params':params, 'dydx':dydx, 'grad': grad, 'grad_input':grad_input, 'blidx':blidx, 'max_level': max_level}
).blocked_autorange())

#  ms @ float,half + 360k rand pts
# 281 ms @ float,half + 3.6M real pts
print(Timer(
    stmt='_backend.lod_bwd_bwd_input(metas, grad_input, grad, x, params, dydx, blidx, None, None, max_level, True, True, False)', 
    globals={'_backend':_backend, 'metas': metas, 'x':x, 'params':params, 'dydx':dydx, 'grad': grad, 'grad_input':grad_input, 'blidx':blidx, 'max_level': max_level}
).blocked_autorange())
...
print(Timer(
    stmt='_backend.lod_bwd_bwd_input(metas, grad_input, grad, x, params, dydx, blidx, None, None, max_level, True, True, True)', 
    globals={'_backend':_backend, 'metas': metas, 'x':x, 'params':params, 'dydx':dydx, 'grad': grad, 'grad_input':grad_input, 'blidx':blidx, 'max_level': max_level}
).blocked_autorange())